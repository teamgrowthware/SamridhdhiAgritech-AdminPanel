...
const AddAreaManager = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const saved = JSON.parse(localStorage.getItem("fieldm")) || [];
   const newId = `FM-${String(saved.length + 1).padStart(4, "0")}`;

    saved.push({ id: newId, ...cleanData });
    localStorage.setItem("fieldm", JSON.stringify(saved));

    navigate("/employees/field");
  };
