...
export default function ManagerDesboard() {
  const [manager, setManager] = useState(null);

  useEffect(() => {
    const stored = JSON.parse(localStorage.getItem("editmanager")) || null;
    setManager(stored);
  }, []);
  ...
  return (
    <div className="ml-64 min-h-screen ">
      ...
      <h2 className="text-xl font-semibold mt-10 mb-3">Manager Employee Details</h2>
