...
function Lost() {
  ...
  useEffect(() => {
    const storedStocks = JSON.parse(localStorage.getItem("loststock")) || [];
  ...
  const editStock = (id) => {
    ...
    if (stockToEdit) {
      localStorage.setItem("editloststock", JSON.stringify(stockToEdit));
      navigate("/stack/lost/addlost");
    }
  };
