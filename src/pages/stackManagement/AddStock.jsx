    ...
    <div className="pt-20 ml-64 mb-60  min-h-screen">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-lg mx-auto relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          {/* ManufactureCost, NetQuantity, BatchNumber */}
          {["ManufactureCost", "NetQuantity", "BatchNumber"].map((field) => (
            <div key={field}>
              <p className="mb-2">
          ...
          <div>
            ...
            <input
              type="date"
              name="ExpiryDate"
              placeholder="Expiry date is required"
          ...
          <div className="flex justify-center gap-6 mt-6">
            ...
            <button
              type="submit"
              className="bg-black text-white px-16 py-2 rounded-lg font-semibold hover:bg-[#5e1aa1] transition-all"
            >
              Save
            </button>
          </div>
