...
function Finished() {
  ...
  useEffect(() => {
    const storedStocks = JSON.parse(localStorage.getItem("finishedStock")) || [];
  ...
  const editStock = (id) => {
    ...
    if (stockToEdit) {
      localStorage.setItem("editfinishedstock", JSON.stringify(stockToEdit));
      navigate("/stack/finished/addfinishedstock");
    }
  };
  ...
  const saveRowEdit = () => {
    ...
    setStocks(newMain);
    localStorage.setItem("finishedStock", JSON.stringify(newMain));
  ...
  return (
    <div className="ml-64 min-h-screen">
      <div className="flex justify-between items-center mb-1">
        <h1 className="mt-5 text-2xl font-semibold">Finished Stock</h1>
        ...
        <div className="flex gap-3 mb-2">
          ...
          <NavLink
            to="/stack/finished/addfinishedstock"
