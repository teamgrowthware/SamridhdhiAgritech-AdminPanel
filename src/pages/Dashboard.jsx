...
export default function Dashboard() {
  ...
  return (
    <div className="lg:ml-64 ml-0 p-4 min-h-screen pt-8">
      {/* STATS CARDS */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-xl shadow">
          <h3 className="font-semibold mb-2 text-gray-600">Sales Performance</h3>
          <ResponsiveContainer width="100%" height={250}>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-black text-white shadow rounded-xl p-4 flex items-center justify-between">
          ...
          <div className="w-10 h-10 border-white border rounded-full"></div>
        </div>
      </div>

      {/* CUSTOMER TABLE */}
      <div className="bg-white rounded-xl shadow p-4 overflow-x-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between pb-3 mb-4 gap-3">
